...
export default function SignupForm(props: Props) {
  return (
    <section className="admin-auth" aria-busy={props.disabled}>
      <div className="auth-card">
        <SignupHeader backHref={props.backHref} onBack={props.onBack} />
        <p className="auth-subtitle">
          Create your provider access. After registration you’ll be redirected
          to the login page.
        </p>
        <AuthFormError error={props.formError} />
        <form className="auth-form" onSubmit={props.onSubmit} noValidate>
          <fieldset disabled={props.disabled} className="auth-fieldset">
            <SignupFields {...props} />
            <TermsField {...props} />
            <SignupActions disabled={props.disabled} onLogin={props.onLogin} />
          </fieldset>
        </form>
      </div>
    </section>
  ...
  return (
    <>
      <AuthInputField
        ...
        onChange={(e) => props.setField("fullName", e.target.value)}
        onBlur={() => props.blurField("fullName")}
        autoComplete="name"
      ...
      <AuthInputField
        ...
        onBlur={() => props.blurField("email")}
        autoComplete="email"
        placeholder="admin@example.com"
        required
        error={props.errors.email}
      />
      <SignupPasswords {...props} />
    </>
  );
}
  ...
  return (
    <>
      <AuthPasswordField
        ...
        onChange={(e) => props.setField("password", e.target.value)}
        onBlur={() => props.blurField("password")}
        minLength={6}
        autoComplete="new-password"
        placeholder="Password"
        required
        error={props.errors.password}
        visible={props.showPw}
        onToggle={() => props.setShowPw((value) => !value)}
        label="Password"
      />
      <AuthPasswordField
        id="confirm"
        ...
        onChange={(e) => props.setField("confirm", e.target.value)}
        onBlur={() => props.blurField("confirm")}
        minLength={6}
        autoComplete="new-password"
        ...
        onToggle={() => props.setShowConfirm((value) => !value)}
    ...
    <div className="auth-check-row">
      <label className="check">
        <input
          ...
          onChange={(e) => props.setField("terms", e.target.checked)}
          onBlur={() => props.blurField("terms")}
        />
      ...
      <AuthErrorSlot error={props.errors.terms} />
    </div>
  );
}
