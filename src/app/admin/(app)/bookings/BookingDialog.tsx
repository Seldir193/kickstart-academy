...
//   const joined = `${program} ${offerType} ${offerTitle}`.trim();

//   if (
//     /personaltraining|personal training|einzeltraining|1:1|1to1|athletik|torwart|goalkeeper|individual|coach education|rent-a-coach|rentacoach/.test(
//       joined,
//     )
//   ) {
//     return "One-Time";
...
//   if (/foerdertraining|kindergarten/.test(joined)) {
//     return "Weekly";
//   }
...
// //   if (
// //     /einzeltraining|1:1|1to1|athletik|torwart|goalkeeper|camp|coach education|rent-a-coach|rentacoach|individual|powertraining/.test(
// //       joined,
// //     )
// //   ) {
// //     return "One-Time";
...
//   if (
//     /personaltraining|personal training|einzeltraining|1:1|1to1|athletik|torwart|goalkeeper|individual/.test(
//       joined,
//     )
//   ) {
//     return "One-Time";
...
//   async function set_subscription_eligible(eligible: boolean) {
//     if (eligible) {
//       const data = await weeklyApproveBooking(booking._id);
...
//                 className="btn btn--success"
//                 aria-disabled={busy ? true : undefined}
//                 onClick={() => run("approvePayment", () => approve_payment())}
//               >
//                 {busy === "approvePayment"
//                   ? "Bitte warten…"
//                   : "Zahlung freigeben"}
...
//                 {/* <div>
//                   <label className="lbl">Für Abo freigegeben am</label>
//                   <div>
//                     {booking.meta?.subscriptionEligibleAt
//                       ? formatDateDe(booking.meta.subscriptionEligibleAt)
//                       : "—"}
