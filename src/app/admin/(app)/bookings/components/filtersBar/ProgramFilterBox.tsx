...
function ProgramGroup(args: {
  labelKey: string;
  options: ProgramOption[];
  props: FilterOptionsProps;
}) {
  return (
    <SelectGroup label={programText(args.props, args.labelKey)}>
...
function ProgramOptionRow(args: {
  value: FilterOptionsProps["program"];
  labelKey: string;
  props: FilterOptionsProps;
}) {
  return (
    <SelectOption
      ...
      text={programText(args.props, args.labelKey)}
    />
  );
}
