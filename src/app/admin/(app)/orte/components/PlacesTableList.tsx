...
// //src\app\admin\(app)\orte\components\PlacesTableList.tsx
// "use client";
...
//               <div className="news-list__h">ID</div>
//               <div className="news-list__h">Name</div>
//               <div className="news-list__h">Adresse</div>
//               <div className="news-list__h">PLZ</div>
//               <div className="news-list__h">Stadt</div>
