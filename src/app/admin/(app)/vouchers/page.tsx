...
//   return { code: "", amount: "", active: true };
// }
...
export default function AdminVouchersPage() {
  ...
  //const list = useVouchersList({ q: qDebounced, status });
  ...
  async function handleCreate(input: {
    ...
    console.log("[handleCreate input]", input);
    setBusy(true);
    try {
      await createVoucher({
        code: input.code,
    ...
    <div className="news-admin ks bookings-admin">
      ...
      <main className="container">
        <div className="dialog-subhead news-admin__subhead">
          <h1 className="text-2xl font-bold m-0 news-admin__title">Vouchers</h1>
          <button
            type="button"
            className="btn"
        ...
        <div className="news-admin__filters">
          ...
          <div className="news-admin__filter" style={sortItemStyle}>
            <label className="lbl news-admin__filter-label">Sorting</label>
