...
function ProfileRows({ data, t }: Props) {
  return (
    <div className="members-info-dialog__list">
      <InfoRow
        label={t("common.admin.members.table.email")}
        value={data.email}
      />
      <InfoRow label={t("common.admin.members.table.role")} value={data.role} />
      <InfoRow
        label={t("common.admin.members.info.owner")}
        value={
          data.isOwner
      ...
      />
      <InfoRow
        label={t("common.admin.members.info.id")}
        value={data.id}
        className="members-info-dialog__value--mono"
      />
    </div>
  );
}
...
export function MemberProfileSection(props: Props) {
  return (
    <Section title={props.t("common.admin.members.info.profile")}>
      <ProfileRows {...props} />
    </Section>
  );
}
...
export function MemberAvatarSection({ data, t }: Props) {
  return (
    <Section title={t("common.admin.members.info.avatar")}>
      <div className="members-info-dialog__list">
        <div className="members-info-dialog__row members-info-dialog__row--multiline">
          ...
          <div className="dialog-value members-info-dialog__value--break">
            <AvatarValue avatarUrl={data.avatarUrl} />
          </div>
        </div>
      </div>
    </Section>
