...
export default function NewsInfoDialog({ open, item, onClose }: Props) {
  ...
  return (
    <div className="dialog-backdrop news-info" role="dialog" aria-modal="true">
      <div className="dialog news-info__dialog">
        <div className="dialog-head news-info__head">
          <div className="news-info__head-left">
            <div className="news-info__title">{data.title}</div>
            <div className="news-info__subtitle">Nur Ansicht</div>
          </div>

          <div className="news-info__head-right">
            <span
              className={`news-info__badge ${
        ...
        <div className="dialog-body news-info__body">
          <div className="news-info__grid">
            <section className="news-info__section">
              <div className="news-info__section-title">Meta</div>

              <div className="news-info__list">
                <div className="news-info__row">
                  <div className="news-info__label">Kategorie</div>
                  <div className="news-info__value">{data.category}</div>
                </div>

                <div className="news-info__row">
                  <div className="news-info__label">Slug</div>
                  <div className="news-info__value">{data.slug}</div>
                </div>

                <div className="news-info__row is-multiline">
                  <div className="news-info__label">Tags</div>
                  <div className="news-info__value">
            ...
            <section className="news-info__section">
              <div className="news-info__section-title">Zeitstempel</div>

              <div className="news-info__list">
                <div className="news-info__row">
                  <div className="news-info__label">Submitted</div>
                  <div className="news-info__value">{data.submittedAt}</div>
                </div>

                <div className="news-info__row">
                  <div className="news-info__label">Approved</div>
                  <div className="news-info__value">{data.approvedAt}</div>
                </div>

                <div className="news-info__row">
                  <div className="news-info__label">Live Update</div>
                  <div className="news-info__value">{data.liveUpdatedAt}</div>
                </div>

                <div className="news-info__row">
                  <div className="news-info__label">Provider Edit</div>
                  <div className="news-info__value">
                ...
                <div className="news-info__row">
                  <div className="news-info__label">Super Edit</div>
                  <div className="news-info__value">{data.lastSuperEditAt}</div>
                </div>
              </div>
            </section>
          </div>
      ...
      <button
        type="button"
        className="news-info__backdrop-hit"
        aria-label="Close"
        onClick={onClose}
      />
    </div>
