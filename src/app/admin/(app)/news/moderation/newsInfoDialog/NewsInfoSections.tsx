...
function getMetaRows(data: NewsInfoDialogData, t: TFunction): RowProps[] {
  return [
    ...
    {
      label: t("common.admin.news.infoDialog.tags"),
...
function getTimestampRows(data: NewsInfoDialogData, t: TFunction): RowProps[] {
  return [
    {
      label: t("common.admin.news.infoDialog.submitted"),
      value: data.submittedAt,
    },
    {
      label: t("common.admin.news.infoDialog.approved"),
      value: data.approvedAt,
    },
    {
      label: t("common.admin.news.infoDialog.liveUpdate"),
      value: data.liveUpdatedAt,
    },
    {
      label: t("common.admin.news.infoDialog.providerEdit"),
      value: data.lastProviderEditAt,
    },
    {
      label: t("common.admin.news.infoDialog.superEdit"),
      value: data.lastSuperEditAt,
    },
  ];
}

export default function NewsInfoSections({
  data,
  t,
}: {
  data: NewsInfoDialogData;
  t: TFunction;
}) {
  return (
    <div className="news-info__grid">
      <NewsInfoSection
        title={t("common.admin.news.infoDialog.meta")}
        rows={getMetaRows(data, t)}
      />
      <NewsInfoSection
        title={t("common.admin.news.infoDialog.timestamps")}
        rows={getTimestampRows(data, t)}
      />
    </div>
  );
}
