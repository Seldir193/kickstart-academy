...
function pendingMine(p: NewsAdminViewModel, d: DeleteDialogState) {
  ...
  return (
    <NewsSection
      titleKey="common.admin.news.page.myNewsPendingReview"
      meta={p.myPendingMeta}
...
function approvedMine(p: NewsAdminViewModel, d: DeleteDialogState) {
  return (
    <NewsSection
      titleKey="common.admin.news.page.myNewsApproved"
      meta={p.myApprovedMeta}
...
function rejectedMine(p: NewsAdminViewModel, d: DeleteDialogState) {
  ...
  return (
    <NewsSection
      titleKey="common.admin.news.page.myNewsRejected"
      meta={p.myRejectedMeta}
