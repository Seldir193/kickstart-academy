  ...
  return (
    <div className="news-list__cell news-list__cell--title">
      <div className="news-list__title">
        {clean(news.title) || t("common.emptyDash")}
      </div>
      <div
        className={`news-list__excerpt ${clean(news.excerpt) ? "" : "is-empty"}`}
      >
        {clean(news.excerpt) || t("common.emptyDash")}
      </div>
    </div>
  );
}
  ...
  return (
    <div className="news-list__cell news-list__cell--cat">
      <span className="news-list__pill">
        {clean(news.category) || t("common.admin.news.list.defaultTitle")}
      </span>
    </div>
  );
}
