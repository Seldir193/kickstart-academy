...
export default function AdminHomeRecentSection(props: Props) {
  return (
    <section className="card news-list admin-home__recent">
      <AdminHomeRecentHeader t={props.t} />
      <RecentBody {...props} />
    </section>
  );
}
...
function RecentBody(props: Props) {
  if (props.loadingList)
    return <RecentEmpty label={props.t("common.admin.home.recent.loading")} />;
  if (props.items.length === 0)
    return <RecentEmpty label={props.t("common.admin.home.recent.empty")} />;
