    ...
    <div className="ks admin-home">
      <main className="container">
        <AdminHomeHero
          ...
          t={t}
          onQuickOpen={() => page.setQuickOpen(true)}
        />
        <AdminHomeStatsGrid counts={page.counts} t={t} />
        <AdminHomeRecentSection
          items={page.recent.items}
          loadingList={page.recent.loadingList}
          page={page.page}
      ...
      <AdminHomePager
        page={page.page}
        pageCount={page.recent.pageCount}
        setPage={page.setPage}
        t={t}
      />
      {page.quickOpen ? null : null}
    </div>
  );
}
