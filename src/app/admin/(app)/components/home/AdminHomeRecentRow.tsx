...
export default function AdminHomeRecentRow({
  offer,
  index,
  page,
  language,
  ...
  return (
    <li
      ...
      onClick={go}
      onKeyDown={(e) => handleActivation(e, go)}
      tabIndex={0}
      role="button"
      aria-label={rowLabel(offer, t)}
    >
      <AdminHomeRecentRowCells
        offer={offer}
        isLatest={page === 1 && index === 0}
        language={language}
        t={t}
      />
      <AdminHomeRecentRowAction onNavigate={go} t={t} />
    </li>
  );
}
