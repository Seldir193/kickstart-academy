...
function OnlineBookingsPageView({
  page,
  t,
}: {
  page: ReturnType<typeof useOnlineBookingsPageState>;
  t: (key: string) => string;
}) {
  return (
    <div className="news-admin ks online-bookings-admin">
      ...
      <main className="container">
        <OnlineBookingsToolbar
          {...page}
          t={t}
          total={page.list.total}
          totalAll={page.list.totalAll}
          counts={page.list.counts}
        />
        <ErrorCard error={page.list.error} />
        <OnlineBookingsListSection
          t={t}
          total={page.list.total}
          items={page.itemsSorted}
          page={page.page}
          ...
          setSel={page.setSel}
          onDeleteMany={page.onDeleteMany}
          onRestoreMany={page.onRestoreMany}
        />
      </main>
      <OnlineBookingDialogMount
        booking={page.sel}
        setSel={page.setSel}
        reload={page.list.reload}
        showOk={page.showOk}
        onConfirm={page.onConfirm}
        onSetStatus={page.onSetStatus}
        onDeleteOne={page.onDeleteOne}
        onCancelConfirmed={page.onCancelConfirmed}
        onApprovePayment={page.onApprovePayment}
      />
    </div>
  );
}
