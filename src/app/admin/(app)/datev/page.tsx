  ...
  return (
    <div className="p-4 max-w-2xl datev-export-page">
      ...
      <div className="text-sm text-gray-600 mb-4">
        Exportiert <b>Rechnungen</b> & <b>Gutschriften</b> sowie{" "}
        <b>Mahn-/Zahlungserinnerungs-Gebühren</b> als ZIP mit
        <code className="mx-1">buchungen_extf.csv</code> und
        <code className="mx-1">buchungen_readable.csv</code>.
        <span className="block mt-1">
          Hinweis: Die Mahngebühren werden als separate Buchungszeilen
          (RLS/MAHN/BEARB) exportiert, falls der Betrag &gt; 0 ist.
        </span>
      </div>
