...
export default function PendingProviderSection(props: PendingSectionProps) {
  ...
  return (
    <LocationsSectionShell title={title} meta={meta} pending pagination={pagination}>
      <div className="news-admin__box--scroll3">
        <PendingLocationsList items={p.pagProvPending.items} loading={false} showChangeInfo={true} onOpen={p.openEdit} onApprove={p.approveOne} onReject={p.openReject} />
      </div>
