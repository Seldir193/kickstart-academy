...
export default function FranchiseLocationProviderSections(props: PageHandlersProps) {
  return <><ProviderPendingSection p={props.p} t={props.t} /><ProviderApprovedSection {...props} /><ProviderRejectedSection {...props} /><MineApprovedSection {...props} /></>;
}
