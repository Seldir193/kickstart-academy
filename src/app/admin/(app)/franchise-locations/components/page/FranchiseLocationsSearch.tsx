  ...
  return (
    <div className="fl-filters__search">
      <div className="input-with-icon">
        ...
        <input className="input input-with-icon__input" placeholder={t("common.admin.franchiseLocations.searchPlaceholder")} aria-label={t("common.admin.franchiseLocations.searchAria")} value={p.q} onChange={(e) => p.setQ(e.target.value)} onKeyDown={(e) => clearOnEscape(e, p)} />
      </div>
    </div>
  );
}
