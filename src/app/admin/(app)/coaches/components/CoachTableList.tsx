...
function positionLabel(c: Coach, t: Translate) {
  const s = cleanStr((c as any).position);
  return s || t("common.admin.coaches.table.positionFallback");
}
...
function normalizedPendingLabel(c: Coach, t: Translate, authorDash?: boolean) {
...
function statusLabel(c: Coach, t: Translate, authorDash?: boolean) {
...
export default function CoachTableList({
  ...
  function authorText(c: Coach, t: Translate) {
    if (authorDash)
    ...
    return (
      <section className="card">
        <div className="card__empty">
          {t("common.admin.coaches.table.empty")}
        </div>
      </section>
    );
  }
      ...
      <section className="card coach-list">
        <div className="coach-list__table">
          <div className="coach-list__head" aria-hidden="true">
            <div className="coach-list__h">
              {t("common.admin.coaches.table.name")}
            </div>
            <div className="coach-list__h">
              {t("common.admin.coaches.table.position")}
            </div>
            <div className="coach-list__h">
              {t("common.admin.coaches.table.since")}
            </div>
            <div className="coach-list__h">
              {t("common.admin.coaches.table.status")}
            </div>
            <div className="coach-list__h">
              {t("common.admin.coaches.table.author")}
            </div>
            <div className="coach-list__h coach-list__h--right">
              {t("common.admin.coaches.table.action")}
            </div>
          </div>
              ...
              return (
                ...
                >
                  <div className="coach-list__cell coach-list__cell--name">
                    ...
                    >
                      {cleanStr(getSlug(c)) ||
                        t("common.admin.coaches.table.emptyValue")}
                    </div>
                  </div>

                  <div className="coach-list__cell coach-list__cell--pos">
                    <span className="coach-list__pill">
                      {positionLabel(c, t)}
                    </span>
                  </div>
                    ...
                    >
                      ...
                      {showSubmit ? (
                        <span
                          ...
                          title={t(
                            "common.admin.coaches.table.submitForReview",
                          )}
                        >
                          <img
