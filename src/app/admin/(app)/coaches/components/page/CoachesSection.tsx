...
type Props = { title: ReactNode; meta?: ReactNode; page: number; pages: number; onPrev: () => void; onNext: () => void; children?: ReactNode };
...
function SectionBody({ children }: { children?: ReactNode }) {
  return <div className="coach-admin__box coach-admin__box--scroll3">{children}</div>;
}
