...
export default function CoachesAdminPage() {
  ...
  const meLabel =
    cleanStr((me as any)?.fullName) || t("common.admin.coaches.page.meLabel");
      ...
      <main className="container">
          ...
          <section className="coach-admin__section">
            <div className="coach-admin__section-head">
              <h2 className="coach-admin__section-title">
                {t("common.admin.coaches.page.providersPendingReview")}
              </h2>
              <span className="coach-admin__section-meta">
                {pendingCount
                  ? t("common.admin.coaches.page.countNew", {
                      count: pendingCount,
                    })
                  : ""}
              </span>
        ...
        {isSuper ? (
          <section className="coach-admin__section">
            <div className="coach-admin__section-head">
              <h2 className="coach-admin__section-title">
                {t("common.admin.coaches.page.providersApproved")}
              </h2>
              <span className="coach-admin__section-meta">
        ...
        {isSuper ? (
          <section className="coach-admin__section">
            <div className="coach-admin__section-head">
              <h2 className="coach-admin__section-title">
                {t("common.admin.coaches.page.providersRejected")}
              </h2>
              <span className="coach-admin__section-meta">
        ...
        {!isSuper ? (
          <section className="coach-admin__section">
            <div className="coach-admin__section-head">
              <h2 className="coach-admin__section-title">
                {t("common.admin.coaches.page.coachesPendingReview")}
              </h2>
              <span className="coach-admin__section-meta">
        ...
        {!isSuper ? (
          <section className="coach-admin__section">
            <div className="coach-admin__section-head">
              <h2 className="coach-admin__section-title">
                {t("common.admin.coaches.page.coachesApproved")}
              </h2>
              <span className="coach-admin__section-meta">
        ...
        {!isSuper ? (
          <section className="coach-admin__section">
            <div className="coach-admin__section-head">
              <h2 className="coach-admin__section-title">
                {t("common.admin.coaches.page.coachesRejected")}
              </h2>
              <span className="coach-admin__section-meta">
        ...
        {isSuper ? (
          <section className="coach-admin__section">
            <div className="coach-admin__section-head">
              <h2 className="coach-admin__section-title">
                {t("common.admin.coaches.page.myCoachesApproved")}
              </h2>
              <span className="coach-admin__section-meta">
                {state.myLists.approved.length
                  ? `(${state.myLists.approved.length})`
