...
export default function CustomersPageContent() {
  ...
  return <div className="ks-customers-admin admin-scope p-4 max-w-6xl mx-auto"><CustomersToolbar model={model} t={t} /><CustomersErrorCard error={model.list.err} t={t} /><CustomersTableSection model={model} /><CustomersPager model={model} t={t} /><CustomersDialogMount model={model} /></div>;
}
