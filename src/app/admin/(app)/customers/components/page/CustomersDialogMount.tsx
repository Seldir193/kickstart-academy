...
function CreateDialog({ model }: Props) {
  ...
  return (
    <CustomerDialog
      mode="create"
      onClose={model.dialogs.closeCreate}
      onCreated={model.actions.afterCreate}
    />
  );
}
...
function EditDialog({ model }: Props) {
  ...
  return (
    <CustomerDialog
      mode="edit"
      customer={model.dialogs.editing}
      onClose={model.dialogs.closeEdit}
      onSaved={model.actions.afterEditClose}
      onDeleted={model.actions.afterEditClose}
    />
  );
}
