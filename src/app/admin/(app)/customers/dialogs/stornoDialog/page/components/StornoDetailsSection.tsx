  ...
  return (
    <section className="dialog-section storno-dialog__detailsSection">
      ...
      <div className="dialog-section__body ks-storno__section">
        <NoteField t={t} bookings={bookings} submit={submit} />
      </div>
    </section>
  );
}
  ...
  return (
    <div>
      ...
      <textarea
        ...
        rows={3}
        value={submit.note}
        onChange={(e) => submit.setNote(e.target.value)}
        placeholder={t("common.admin.customers.stornoDialog.notePlaceholder")}
        disabled={!bookings.selected || bookings.isCancelled}
      />
    </div>
  );
}
