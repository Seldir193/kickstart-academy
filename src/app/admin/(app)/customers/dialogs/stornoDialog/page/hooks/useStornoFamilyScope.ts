...
export function useStornoFamilyScope(customerId: string, t: TFunc): FamilyScopeState {
...
function useFamilyDropdownRefs() {
  ...
  useDropdownOutsideClose([{ ref: parentDropdownRef, close: () => parentOpen.setOpen(false) }, { ref: childDropdownRef, close: () => childOpen.setOpen(false) }]);
  return dropdownRefs(parentDropdownRef, childDropdownRef, parentOpen, childOpen);
}
...
function dropdownRefs(parentDropdownRef: any, childDropdownRef: any, parentOpen: any, childOpen: any) {
  return { parentDropdownRef, childDropdownRef, isParentDropdownOpen: parentOpen.open, isChildDropdownOpen: childOpen.open, setIsParentDropdownOpen: parentOpen.setOpen, setIsChildDropdownOpen: childOpen.setOpen };
}
...
function buildFamilyState(base: any, selection: any, refs: any, options: any, t: TFunc) {
  ...
  return { ...base, ...selection, ...refs, ...options, selectedParent, activeChild, selfMemberId, selectedParentLabel: parentLabel(selectedParent, t) };
}

function parentLabel(selectedParent: any, t: TFunc) {
  if (!selectedParent) return t("common.admin.customers.stornoDialog.selectParent");
  return selectedParentName(selectedParent, t("common.admin.customers.stornoDialog.parent"));
}
