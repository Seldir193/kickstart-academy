...
import type { CancelBookingsState, CancelMenuState, CancelSubmitState, FamilyScopeState, TFunc } from "../types";
...
export default function CancelDialogBody(props: Props) {
  return (
    <div className="dialog-body cancel-dialog__body">
      ...
      <CancelFiltersSection t={props.t} menus={props.menus} bookings={props.bookings} submit={props.submit} />
      <CancelDetailsSection t={props.t} bookings={props.bookings} submit={props.submit} />
    </div>
  );
}
