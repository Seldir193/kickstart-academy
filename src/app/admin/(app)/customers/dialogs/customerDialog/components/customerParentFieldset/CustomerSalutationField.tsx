...
function salutationLabel(value: string | undefined, t: TFunction) {
  if (value === "Frau")
    return t("common.admin.customers.customerDialog.salutationMs");
  if (value === "Herr")
    return t("common.admin.customers.customerDialog.salutationMr");
  return "—";
}
...
export default function CustomerSalutationField({
  p,
  t,
}: {
    ...
    <div>
      ...
      >
        <button
          ...
          onClick={() => p.setSalutationOpen((open) => !open)}
        >
          <span className="ks-selectbox__label">
            {salutationLabel(value, t)}
          </span>
        ...
        {p.salutationOpen ? (
          <div className="ks-selectbox__panel">
            ...
            <button
              type="button"
              className={optionClass(value === "Frau")}
              onClick={() => choose(p, "Frau")}
            >
              {t("common.admin.customers.customerDialog.salutationMs")}
            </button>
            <button
              type="button"
              className={optionClass(value === "Herr")}
              onClick={() => choose(p, "Herr")}
            >
