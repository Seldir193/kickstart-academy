...
export default function BookDialogWeeklySection({ controller }: Props) {
  ...
  return (
    <DetailsSection
      title={controller.t(
        "common.admin.customers.bookDialog.subscriptionDetails",
      )}
    >
      <CampCard
      ...
      >
        <WeeklySummary controller={controller} />
      ...
      items={[
        {
          ...
          value: controller.offers.regularCourseLine,
        },
        {
          label: controller.t("common.admin.customers.bookDialog.hint"),
          value: controller.offers.weeklyHolidayNotice,
        },
      ]}
    />
  );
