...
export default function BookDialogPowertrainingSection({ controller }: Props) {
  ...
  return <DetailsSection title={controller.t("common.admin.customers.bookDialog.powertrainingDetails")}><CampCard eyebrow={controller.t("common.admin.customers.bookDialog.holidayProgram")} title={controller.t("common.admin.customers.bookDialog.powertrainingDetails")}><PowertrainingSummary controller={controller} /><FooterBlock controller={controller} /></CampCard></DetailsSection>;
}
