...
export default function BookDialogDynamicSections({ controller }: Props) {
  return (
    <div className="book-dialog__dynamic">
      <BookDialogCampSection controller={controller} />
      <BookDialogPowertrainingSection controller={controller} />
      <BookDialogOneTimeSection controller={controller} />
      <BookDialogWeeklySection controller={controller} />
    </div>
  );
}
