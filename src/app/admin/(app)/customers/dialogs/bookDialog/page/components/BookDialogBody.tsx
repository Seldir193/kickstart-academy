...
export default function BookDialogBody({ controller }: Props) {
  return (
    <div className="dialog-body book-dialog__body book-form">
      <BookDialogStatusSection controller={controller} />
      <BookDialogFamilySection controller={controller} />
      <BookDialogSelectionSection controller={controller} />
      <BookDialogDynamicSections controller={controller} />
    </div>
  );
}
