...
import { BookingDetailsTitle, CampCard, DetailsSection } from "./BookDialogDetailsLayout";
...
export default function BookDialogOneTimeSection({ controller }: Props) {
  ...
  return <DetailsSection title={controller.t("common.admin.customers.bookDialog.bookingDetails")}><CampCard eyebrow={controller.t("common.admin.customers.bookDialog.oneTimeBooking")} title={controller.t("common.admin.customers.bookDialog.bookingDetails")}><FooterBlock controller={controller} /></CampCard></DetailsSection>;
}
