...
export function useBookDialogController(props: BookDialogProps): BookDialogController {
  ...
  const submit = useBookSubmit({ customerId: props.customerId, onClose: props.onClose, onBooked: props.onBooked, family, offers, details, t });
