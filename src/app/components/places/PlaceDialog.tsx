          ...
          <div className="place-dialog__grid">
            <section className="dialog-section place-dialog__section">
              <div className="dialog-section__head">
                <h3 className="dialog-section__title">Location details</h3>
              </div>

              <div className="dialog-section__body place-dialog__section-body">
                <div className="field">
                  <label className="dialog-label">Club / Place name</label>
                  <input
                    className="input"
                    value={form.name}
                    onChange={(e) =>
            ...
            <section className="dialog-section place-dialog__section">
              <div className="dialog-section__head">
                <h3 className="dialog-section__title">Map preview</h3>
              </div>
