...
export default function OfferCreateDialog({
  ...
  const [coachFileName, setCoachFileName] = React.useState("None selected");
        ...
        {d.isHolidayOffer ? (
          <>
            ...
            <div className="grid grid--2 offer-create-dialog">
              <div className="form__group">
                <label className="label">Holiday: From</label>
                <KsDatePicker
              ...
              <div className="form__group">
                <label className="label">Holiday: To</label>
                <KsDatePicker
                  value={d.form.dateTo || ""}
                  onChange={(nextIso) =>
                    d.setForm((f) => ({
            ...
            <div className="ks-file">
              <input
                ...
                onChange={(e) => {
                  ...
                  setCoachFileName(file?.name || "None selected");
              ...
              <span
                className={
                  "ks-file__name" +
                  (coachFileName === "None selected" ? " is-empty" : "")
                }
                aria-live="polite"
              >
                {coachFileName}
