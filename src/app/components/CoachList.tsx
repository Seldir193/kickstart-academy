...
//     const url = `${base}/api/admin/coaches?q=${encodeURIComponent(
//       q,
//     )}&page=1&limit=${limit}`;
...
//   const allSelected =
//     state.items.length > 0 && selected.length === state.items.length;
...
//     const base = (process.env.NEXT_PUBLIC_API_BASE || "").replace(/\/+$/, "");
//     const r = await fetch(
//       `${base}/api/admin/coaches/${encodeURIComponent(slug)}`,
//       {
//         method: "PATCH",
//         headers: { "Content-Type": "application/json" },
//         body: JSON.stringify(values),
...
//     await Promise.all(
//       selected.map((slug) =>
//         fetch(`${base}/api/admin/coaches/${encodeURIComponent(slug)}`, {
//           method: "DELETE",
//         }).catch(() => {}),
//       ),
//     );
...
//                 {/* Position */}
//                 <div className="coach-table__pos">
//                   {c.position || "Trainer"}
//                 </div>
...
//                 {/* Edit-Icon */}
//                 <div
//                   className="coach-table__actions"
...
//         onSubmit={async (vals) => {
//           if (editing) await handleSave(editing.slug, vals);
//         }}
//       />
//     </div>
//   );
